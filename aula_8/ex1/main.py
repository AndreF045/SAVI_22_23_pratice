...
def main():
    ...
    q_path = '/home/andre/SAVI/SAVI_22_23_pratice/aula_8/ex1/images/machu_pichu/2.png'
    q_image = cv2.imread(q_path)
    q_gui = deepcopy(q_image)
    q_gray = cv2.cvtColor(q_image,cv2.COLOR_BGR2GRAY)
    q_win_name = 'Query Image'

    t_path = '/home/andre/SAVI/SAVI_22_23_pratice/aula_8/ex1/images/machu_pichu/1.png'
